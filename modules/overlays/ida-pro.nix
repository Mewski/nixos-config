{ inputs, ... }:
{
  perSystem =
    ...
    {
      overlayAttrs = {
        ida-pro-mcp = pkgs.python3Packages.buildPythonApplication {
          pname = "ida-pro-mcp";
          version = "1.4.0";
        ...
        ida-pro-wayland = inputs.ida-pro.packages.${system}.ida-pro-wayland.overrideAttrs (old: {
        ...
        bindiff = pkgs.stdenv.mkDerivation {
          pname = "bindiff";
          version = "8";
          src = pkgs.fetchurl {
        ...
        bindiff-ida-plugins = pkgs.stdenv.mkDerivation {
